...
pub(in crate::ui) fn label_value_from_list(labels: &str, key: &str) -> Option<String> {
...
fn shell_execute_action(
    ...
    match a {
        ...
        ShellAction::StackUpdate => {
            commands::cmdline_cmd::stack_update(app, action_req_tx, false, None);
        }
        ShellAction::StackUpdateAll => {
            commands::cmdline_cmd::stack_update(app, action_req_tx, true, None);
        }
        ShellAction::Console => {
